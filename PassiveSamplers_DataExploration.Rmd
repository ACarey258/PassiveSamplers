...
ggsave(Biofilm, height = 4, width = 4, dpi = 300, filename = "Biofilm_pgg.png")
...
SPMDs + annotate("text", x = 1, y = 60, label = "A", size = 10)
...
TPBDEs in Biofilm (pg/g) compared with SPMDs (pg/L)
